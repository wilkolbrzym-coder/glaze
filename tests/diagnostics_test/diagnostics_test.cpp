...
struct invalid_struct {
   int x{42};
   std::thread t{}; // thread is not serializable
};
...
suite diagnostics_tests = [] {
   ...
   "invalid_struct_unsupported"_test = [] {
      // Test writing support concepts should be false for invalid struct
      static_assert(!glz::write_supported<invalid_struct, glz::JSON>);
      static_assert(!glz::write_supported<invalid_struct, glz::CBOR>);
      static_assert(!glz::write_supported<invalid_struct, glz::BEVE>);
      static_assert(!glz::write_supported<invalid_struct, glz::YAML>);
      static_assert(!glz::write_supported<invalid_struct, glz::TOML>);
      static_assert(!glz::write_supported<invalid_struct, glz::MSGPACK>);
      static_assert(!glz::write_supported<invalid_struct, glz::BSON>);

      // Test reading support concepts should be false for invalid struct
      static_assert(!glz::read_supported<invalid_struct, glz::JSON>);
      static_assert(!glz::read_supported<invalid_struct, glz::CBOR>);
      static_assert(!glz::read_supported<invalid_struct, glz::BEVE>);
      static_assert(!glz::read_supported<invalid_struct, glz::YAML>);
      static_assert(!glz::read_supported<invalid_struct, glz::TOML>);
      static_assert(!glz::read_supported<invalid_struct, glz::MSGPACK>);
      static_assert(!glz::read_supported<invalid_struct, glz::BSON>);
   };
